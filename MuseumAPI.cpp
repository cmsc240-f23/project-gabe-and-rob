...
map<std::string, Exhibit> exhibitssMap = loadFromFile<Exhibit>("exhibits.json");
map<std::string, Storage> storagessMap = loadFromFile<Storage>("storages.json");
map<std::string, Object> storagesMap = loadFromFile<Object>("objects.json");
